...
> **For agentic workers:** REQUIRED: Use superpowers-custom:subagent-driven-development (if subagents available) or superpowers-custom:executing-plans to implement this plan.
...
```markdown
> **For agentic workers:** REQUIRED: Use superpowers-custom:subagent-driven-development (if subagents available) or superpowers-custom:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
