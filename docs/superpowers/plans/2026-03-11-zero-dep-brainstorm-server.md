...
> **For agentic workers:** REQUIRED: Use superpowers-custom:subagent-driven-development (if subagents available) or superpowers-custom:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.
