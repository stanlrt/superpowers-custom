...
```
- **superpowers-custom:using-git-worktrees** - REQUIRED: Set up isolated workspace before starting
```
To:
```
- **superpowers-custom:using-git-worktrees** - REQUIRED: Ensures isolated workspace (creates one or verifies existing)
```
